...
class ApiController extends BaseController
{
    ...
    public function openGlAndEs() {
        $this->setPage('OpenGL');
        $this->apis = array(
            'OpenGL',
            'OpenGL ES',
            \Mesamatrix\Parser\Constants::GL_OR_ES_EXTRA_NAME);

        $this->writeHtml();
    }

    public function vulkan() {
        $this->setPage('Vulkan');
        $this->apis = array(
            'Vulkan',
            \Mesamatrix\Parser\Constants::VK_EXTRA_NAME);
    ...
    protected function computeRendering() {
        ...
        $this->createLeaderboard($xml);
        $this->createMatrixModel($xml);
    }
    ...
    private function createMatrixModel(\SimpleXMLElement $xml) {
        $xmlApis = array();
